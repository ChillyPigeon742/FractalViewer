...
public class ShaderLoader {
    ...
    static {
        ...
        Event.LOAD_SHADER_SOURCE.subscribe(SubscribeMethod.SYNC, ignored -> loadShaders());
        Event.UNLOAD_SHADER_SOURCE.subscribe(SubscribeMethod.SYNC, ignored -> unloadShaders());
    }

    private static String loadShaderSource(String filepath) {
        try {
            Path file = Path.of(Objects.requireNonNull(
                    ShaderLoader.class.getResource(filepath)).toURI());
